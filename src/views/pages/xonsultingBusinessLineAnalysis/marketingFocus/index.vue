    ...
    <el-container class="page-box">
        ...
        <el-header class="header-box">
            <div>
                ...
                <div>
                    <span style="color: #409eff;font-weight: 800;">销售:共{{ totle }}条有效数据，包含{{ totleL2 }}个二级指标，{{ totleL3 }}个三级指标
                    </span>
                </div>
...
// 处理一级指标
const list_l1 = getGroupData('Level 1-中文', l1l2l3Data).find(item => item.name === '营销关注').children || []
...
export default {
    ...
    methods: {
        ...
        exportData(){
            ...
            uuT.exportToExcel(tHeader, data, '营销关注')
        },
        clickL2Item (params) {
            const { name } = params
