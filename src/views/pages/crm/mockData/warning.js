...
const color = ['#FFBF00', '#80FFA5', '#00DDFF', '#37A2FF', '#FF0087']
...
const c2 = ['警示灯报警提示（驻车制动器）', '警示灯种类咨询', '维修-保养', '调节-检测问题-维修-使用-如何调节', , '中央服务如何', '销售量怎么样', '电力问题如何解决', '车道保持什么距离', '商店多少钱', '语音好用吗']
