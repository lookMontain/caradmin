...
const ci = ['胎压信息显示咨询','仪表盘信息显示种类咨询','里程数信息显示咨询（复位，查看等）','保养提示信息显示咨询','油表信息显示咨询','如何关闭仪表盘信息提示咨询','出风口调节咨询','温度调节咨询','蓝牙无法连接']
...
const c2 = ['辅助系统图示咨询','信息显示错误/不准确','导航信息显示咨询','水温表信息显示咨询',,'音频信息显示咨询','电话信息显示咨询','前挡风加热咨询','后视镜加热咨询','后排空调操作咨询','吹风角度调节咨询','蓝牙连接方式咨询']
